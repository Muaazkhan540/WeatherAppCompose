...
class TinyDB constructor(private val appContext: Context) {
    ...
    var String.initInt: Int
        get() = preferences.getInt(this, 0)
        set(value) = preferences.edit { putInt(this@initInt, value) }

    var String.initFloat: Float
        get() = preferences.getFloat(this, 0f)
        set(value) = preferences.edit { putFloat(this@initFloat, value) }
    var String.initString: String?
        get() = preferences.getString(this, "")
        set(value) = preferences.edit { putString(this@initString, value) }
    var String.initBoolean: Boolean
        get() = preferences.getBoolean(this, false)
        set(value) = preferences.edit { putBoolean(this@initBoolean, value) }
